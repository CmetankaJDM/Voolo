 ...
 *  • Цены — целые числа в минорных единицах не храним: Aviasales отдаёт рубли
 *    целыми, и выдумывать копейки там, где их нет, вредно.
...
// Строка создаётся ДО выставления инвойса в статусе pending, иначе на pre_checkout
// проверять нечего, а времени там десять секунд.
